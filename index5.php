<?php
    include_once 'includes/survey5.php';
?>
<!DOCTYPE html>
<html>
<html lang="es">
...
<body>
    ...
    <form action="#" method="POST">
        <h2>¿Sabe cuales son los metodos para prevenir el contagio del covid-19?</h2>
        <?php
            if($showResults){
                ...
                foreach ($queryLanguages as $lenguaje) {
                    ...
                    include 'vistas/vista-resultados5.php';
                }
                include 'vistas/sig5.php';
            }else{
                include 'vistas/vista-votacion5.php';
            }
        ?> 
    </form>
</section>
