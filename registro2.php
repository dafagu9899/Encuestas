...
<body style="background-color: #084B8A">
		<header>
        <div class="menu_bar">
            <a href="#" class="bt-menu"><span class="icon-briefcase"></span>Encuesta Covid-19</a>
        </div>
 
        <nav>
            <ul>
                <li><a href=""><span class="icon-briefcase"></span>Encuesta Covid-19</a></li>
            </ul>
        </nav>
    </header>
<section>
	<div class="row">
		...
		<div class="col-sm-4">
					...
					<p></p>
					<a href="index4.php" class="btn btn-primary" id="registrarNuevo">Registrar</a>
