<?php
    include_once 'includes/survey2.php';
?>
<!DOCTYPE html>
<html>
<html lang="es">
...
<body>
    ...
    <form action="#" method="POST">
        <h2>¿Estos niños a los que piensa festejar este año con motivo del Día del Niño/a son?</h2>
        <?php
            if($showResults){
                ...
                foreach ($queryLanguages as $lenguaje) {
                  ...
                  include 'vistas/vista-resultados2.php';
                    
                }include 'vistas/sig2.php';
            }else{
                include 'vistas/vista-votacion2.php';
            }
        ?>
</form>
</section>
