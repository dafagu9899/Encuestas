<?php
    include_once 'includes/survey3.php';
?>
<!DOCTYPE html>
<html>
<html lang="es">
...
<body>
    ...
    <form action="#" method="POST">
        <h2>¿Cuánto piensa gastar usted en total por este motivo?</h2>
        <?php
            if($showResults){
                ...
                foreach ($queryLanguages as $lenguaje) {
                  ...
                  include 'vistas/vista-resultados3.php';
                    
                }include 'vistas/sig3.php';
            }else{
                include 'vistas/vista-votacion3.php';
            }
        ?>
</form>
</section>
